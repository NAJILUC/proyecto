<%-- 
    Document   : single
    Created on : 21/10/2020, 08:24:35 AM
    Author     : HP
--%>
 ...
 <div class="header-top">
   ...
   <div class="header-bottom">
        ...
        %>
			...
			<div class="cont1 span_2_of_a1">
				...
				<div class="price_single">
							  ...
							  <span class="actual">$<%=producto.getValor()%></span><a href="#">click for offer</a>
							</div>
				<ul class="options">
    			...
    			<p class="m_desc"><%=producto.getDescripcion()%></p>
	...
	<script type="text/javascript" src="../js/jquery.flexisel.js"></script>
	 ...
	 <div class="toogle">
     	<h3 class="m_3">Detalles</h3>
     	<p class="m_text"><%=producto.getDetalle()%></p>
     </div>					
	 <div class="toogle">
     	<h3 class="m_3">Referencia</h3>
     	<p class="m_text"><%=producto.getReferencia()%></p>
     </div>
     </div>
     <div class="clear"></div>
	 </div>
