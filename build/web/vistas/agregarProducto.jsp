       ...
       <div class="register_account">
              ...
              <form action="Controlador">
    			 <div class="col_2_of_2 span_2_of_2">
		   			 <div><input type="text" name="txtReferencia" value="Referencia" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Referencia';}"></div>
		    			<div><input type="text" name="txtNombre" value="Nombre" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Nombre';}"></div>
		    			<div><input type="text" name="txtDescripcion" value="Descripcion" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Descripcion';}"></div>
                                        <div><input type="text" name="txtDetalle" value="Detalle" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Detalle';}"></div>
                                        <div><input type="text" name="txtValor" value="Precio" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Precio';}"></div>
		    	 </div>
                  <button class="grey" name="accion" value="addProducto">Submit</button>
